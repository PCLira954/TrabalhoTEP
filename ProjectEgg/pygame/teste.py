...
ovo = pygame.image.load("imagensjogo/ovo1.png")
rock = pygame.image.load("imagensjogo/smallrockround_640.png")
...
class Hurdles():
    def __init__(self, size, speed) -> None:
        ...
        self.speed = speed
        self.left = 1600
        self.image = pygame.transform.scale(rock, (5 * self.size, 7 * self.size))  # Escalando a imagem do obstáculo
    ...
    def draw(self):
        ...
        self.imagem = pygame.image.load("imagensjogo/obstaculo.png")
        screen.blit(self.imagem, (self.left, self.top, self.width, self.height))
    ...
    def erase_hurdle(self):
        # Move o obstáculo para fora da tela
        self.left = -80

    def get_dimensions(self):
        # Retorna as dimensões do obstáculo para verificar colisões
...
while running:
    ...
    screen.blit(ovo, (player_pos.x, player_pos.y - 50))
